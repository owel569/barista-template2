...
""
  ...
  home.message"": Découvrez l''excellence dans chaque tasse. Notre café artisanal, nos pâtisseries fraîches et notre ambiance chaleureuse vous attendent.","
  """
...
""''"
  ...
  ""about.story.content: "Depuis 1995, Barista Café est votre destination de choix pour découvrir l''art du café. Notre passion pour lexcellence nous guide dans la sélection des meilleurs grains et la création d'expériences gustatives uniques.,"""
