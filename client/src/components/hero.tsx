...
"""
export default export function Hero(): JSX.Element  {""
...
"""
  return (""
    <section id=""home className="relative h-screen flex items-center justify-center overflow-hidden></section>"""
      ...
      /></div>""
      <div className=""absolute inset-0 bg-coffee-dark bg-opacity-60\ /></div>""""
      <div className=relative" z-10 text-center text-white px-6></div>"""
        <div className="flex justify-center mb-8></div>""""
          <img src={logoBaristaCafe""} alt=Barista Café Logo" className=h-48"" w-48 drop-shadow-2xl /></img>""
        </div>"""
        <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in drop-shadow-lg></h1>"""
        ...
        <div className=""flex flex-col sm:flex-row gap-4 justify-center></div>""
          ...
          >"""
            <Utensils className="mr-2 h-5 w-5 ></Utensils>""
            {t(home.cta.menu)}
          </Button>
        </div>'"
      </div>"'''"
