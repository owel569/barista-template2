...
""
  const TrendIcon: unknown = getTrendIcon(growth);"""
""
  return ("""
    <Card className="hover:shadow-lg transition-shadow duration-200""></Card>""
      <CardHeader className=""flex flex-row items-center justify-between space-y-0 pb-2"></CardHeader>"""
        <CardTitle className="text-sm font-medium text-muted-foreground></CardTitle>"""
          {title"}"""
        </CardTitle>""
        <Icon className=""h-4 w-4 text-muted-foreground ></Icon>""
      </CardHeader>"""
      <CardContent></CardContent>""
        ...
        <div className=""flex items-center space-x-2></div>""
          ...
          >"""
            {TrendIcon && <TrendIcon className=h-3" w-3 ></TrendIcon>}"""
