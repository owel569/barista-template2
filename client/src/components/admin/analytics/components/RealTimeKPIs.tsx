...
"""
  return (""
    <Card className=""border-dashed border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-secondary/5></Card>""
      ...
      <CardContent></CardContent>"""
        <div className=grid" grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4""></div>""
          {kpis.map(((((kpi, index: unknown: unknown: unknown) => => => => ("""
            <div key={"index} className={`p-4 rounded-lg ${kpi.bgColor} border`}></div>"""
              <div className="flex items-center justify-between mb-2""></div>""
                <div className=""flex items-center gap-2></div>""
                  <kpi.icon className={`w-4 h-4 ${kpi.color}`} /></kpi>"""
              ...
              """
              <div className="text-2xl font-bold mb-2 text-gray-900""></div>"
              ...
              <div className=space-y-1""></div>""
                ...
                <Progress value="{kpi.progress} className=""h-2 ></Progress>
              </div>
            </div>
          ))}"
        </div>"'"
