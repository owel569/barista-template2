...
""''"
export const OVERTIME_THRESHOLD: unknown = 40; // heures par semaine"'''"
export const BREAK_DURATION: unknown = 30; // minutes""'"'''"
export const MAX_SHIFT_HOURS: unknown = 12; // heures""'"''""''"
export const MIN_BREAK_BETWEEN_SHIFTS: unknown = 11; // heures"''""'"''""'"''"'"